...
const categorias = [
  { nombre: "ropa", descripcion: "Prendas para todos los estilos y ocasiones.", img: ropaImg },
  { nombre: "calzado", descripcion: "Zapatos, hombre y mujer para tu look.", img: calzadoImg },
  { nombre: "accesorios", descripcion: "Bolsos, gafas, gorras y más.", img: accesoriosImg },
  { nombre: "relojes", descripcion: "Relojes elegantes y deportivos.", img: relojesImg },
];
      ...
      <div className="categorias-grid">
        {categorias.map((c, i) => (
          <div key={i} className="categoria-card">
            ...
            <button 
              className="btn-ver" 
              onClick={() => navigate(`/productos/${c.nombre}`)}
            >
              Ver más
            </button>
          </div>
